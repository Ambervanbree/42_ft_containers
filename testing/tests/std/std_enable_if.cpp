...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/06/28 12:21:44 by avan-bre          #+#    #+#             */
/*   Updated: 2022/06/28 14:50:24 by avan-bre         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
template <class X, class = typename std::enable_if<std::is_signed<X>::value>::type>
std::string bar(X){
	return "T is signed";
}
